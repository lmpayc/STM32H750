...
void setup_scr_main(lv_ui *ui)
{
    ...
    lv_obj_set_pos(ui->main_Time_label, 11, 54);
    lv_obj_set_size(ui->main_Time_label, 257, 78);
    ...
    lv_obj_set_style_img_recolor_opa(ui->main_large_light_off_img, 40, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_img_recolor(ui->main_large_light_off_img, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
