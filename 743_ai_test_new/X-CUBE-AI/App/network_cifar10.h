/**
  ...
  ******************************************************************************
  */
#ifndef AI_NETWORK_CIFAR10_H
#define AI_NETWORK_CIFAR10_H

#include "network_cifar10_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_NETWORK_CIFAR10_MODEL_NAME          "network_cifar10"
#define AI_NETWORK_CIFAR10_ORIGIN_MODEL_NAME   "best_model"

/******************************************************************************/
#define AI_NETWORK_CIFAR10_ACTIVATIONS_ALIGNMENT   (4)
#define AI_NETWORK_CIFAR10_INPUTS_IN_ACTIVATIONS   (4)
#define AI_NETWORK_CIFAR10_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_NETWORK_CIFAR10_IN_NUM        (1)

AI_DEPRECATED
#define AI_NETWORK_CIFAR10_IN \
  ai_network_cifar10_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_NETWORK_CIFAR10_IN_SIZE { \
  AI_NETWORK_CIFAR10_IN_1_SIZE, \
}
#define AI_NETWORK_CIFAR10_IN_SIZE_BYTES { \
  AI_NETWORK_CIFAR10_IN_1_SIZE_BYTES, \
}
#define AI_NETWORK_CIFAR10_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_NETWORK_CIFAR10_IN_1_HEIGHT      (60)
#define AI_NETWORK_CIFAR10_IN_1_WIDTH       (80)
#define AI_NETWORK_CIFAR10_IN_1_CHANNEL     (3)
#define AI_NETWORK_CIFAR10_IN_1_SIZE        (14400)
#define AI_NETWORK_CIFAR10_IN_1_SIZE_BYTES  (57600)

/******************************************************************************/
#define AI_NETWORK_CIFAR10_OUT_NUM       (1)

AI_DEPRECATED
#define AI_NETWORK_CIFAR10_OUT \
  ai_network_cifar10_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_NETWORK_CIFAR10_OUT_SIZE { \
  AI_NETWORK_CIFAR10_OUT_1_SIZE, \
}
#define AI_NETWORK_CIFAR10_OUT_SIZE_BYTES { \
  AI_NETWORK_CIFAR10_OUT_1_SIZE_BYTES, \
}
#define AI_NETWORK_CIFAR10_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_NETWORK_CIFAR10_OUT_1_CHANNEL     (3)
#define AI_NETWORK_CIFAR10_OUT_1_SIZE        (3)
#define AI_NETWORK_CIFAR10_OUT_1_SIZE_BYTES  (12)

/******************************************************************************/
#define AI_NETWORK_CIFAR10_N_NODES (100)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup network_cifar10
 ...
 * @ref ai_network_cifar10_create. Both the activations memory buffer 
 ...
 * using @ref ai_network_cifar10_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_network_cifar10_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_network_cifar10_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_NETWORK_CIFAR10_*
 * defines into file @ref network_cifar10.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_network_cifar10_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_NETWORK_CIFAR10_H */
