...
void setup_scr_setting(lv_ui *ui)
{
    ...
    ui->setting_backgroud_cont = lv_obj_create(ui->setting);
    ...
    ui->setting_config_cont = lv_obj_create(ui->setting);
    ...
    ui->setting_volume__switch = lv_switch_create(ui->setting);
    ...
    ui->setting_light_pid_lable = lv_label_create(ui->setting);
    ...
    ui->setting_light_pid_switch = lv_switch_create(ui->setting);
